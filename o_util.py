...
class DataLoaderS(object):
    ...
    def _split(self, train, valid, test):
        ...
        New split:
            80% -> Train + Validation
                - 80% of this = Training  (64% overall)
                - 20% of this = Validation (16% overall)
        ...
        train_valid_end = int(1 * total)

        # Validation = 20% of the first 80%
        train_end = int(0.7 * total)

        # Sample indices
        train_set = range(self.P + self.h - 1, total) #FULL DATA
        valid_set = range(train_end, train_valid_end)
        test_set = range(train_end, total)
        ...
        ####################################################################
        # Instead of keeping ONE continuous test window,
        # keep ALL test samples.
        ####################################################################
        self.test_window = self.test
    ...
    def create_columns(self):
        ...
        with open(file_name, 'r',encoding='utf-8') as f:
            ...
            print("Found",len(col),"columns:",col)
