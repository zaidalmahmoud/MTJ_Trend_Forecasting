...
def plot_forecast(data,forecast,confidence,attack,solutions,index,col,alarming=True):
    ...
    colours = ["RoyalBlue", "Crimson", "DarkOrange", "MediumPurple", "MediumVioletRed",
          "DodgerBlue", "Indigo", "DarkCyan", "hotpink", "DarkMagenta","coral",
          "SteelBlue", "brown", "MediumAquamarine", "SlateBlue", "SeaGreen",
          "MediumSpringGreen", "DarkOliveGreen", "OliveDrab", "MediumSeaGreen",
          "DeepSkyBlue", "MediumSlateBlue", "MediumTurquoise", "FireBrick",
          "Teal", "violet", "MediumOrchid", "DarkSalmon", "DarkRed"]
    ...
    x=['2005','2006','2007','2008','2009','2010','2011','2012', '2013','2014', '2015', '2016', '2017', '2018','2019', '2020', '2021','2022','2023','2024','2025','2026', '2027','2028','2029']
    ax.set_xticks([3, 15, 27, 39, 51, 63, 75, 87, 99, 111, 123, 135, 147, 159, 171, 183, 195, 207, 219, 231, 243, 255, 267, 279, 291], x) # positions of years on x axis
...
def save_gap(forecast, attack, solutions,index):
    ...
    with open('model/Bayesian/forecast/gap/'+consistent_name(attack).replace('/','_')+'_gap.csv', 'w', newline='') as file:
        ...
        writer.writerow(['Technology','2026','2027','2028'])
        table=[]
...
def build_graph(file_name):
    ...
    print('Graph loaded with',len(graph),'main techs...')
    return graph
...
for i in range(all.shape[0]):
    for j in range(all.shape[1]):
        if  j >=33:  #auxilary features
            #print('skipping column', j, 'in normalization')
            continue
        else:
